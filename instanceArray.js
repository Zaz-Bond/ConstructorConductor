...
//Now create and push into your users array 3 separate instances of User using the data from above in that exact order
  ...
  //code here
//var per1 = new User('Tyler', 'tylermcginnis33@gmail.com', 'iLoveJS');
//users.push(per1);
...
console.log('Tyler\'s information is ', users[0].name );
//Console.log all of Tylers information
console.log('Tyler\'s information is ', users[0].name );
  //code here

console.log('Lenny\'s information is ' users[2].name);
